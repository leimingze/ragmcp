...
class ZhipuLLM(LLMClient):
    """ZhipuAI (智谱) LLM provider.

    This client uses ZhipuAI's API (OpenAI-compatible) to generate text completions.
    """
    ...
    def chat(
        ...
        """
        # Convert Message format to Zhipu format (OpenAI-compatible)
        zhipu_messages = [
